    ...
    .then((book_id) => {
      ...
      return Promise.join(
        knex('books_authors').insert({
          author_id: authorIds[0][0],
          book_id: bookIds[0][0]
        }),
        knex('books_authors').insert({
          author_id: authorIds[1][0],
          book_id: bookIds[1][0]
        }),
        knex('books_authors').insert({
          author_id: authorIds[2][0],
          book_id: bookIds[2][0]
        }),
        knex('books_authors').insert({
          author_id: authorIds[3][0],
          book_id: bookIds[3][0]
        }),
        knex('books_authors').insert({
          author_id: authorIds[4][0],
          book_id: bookIds[4][0]
        }),
        knex('books_authors').insert({
          author_id: authorIds[5][0],
          book_id: bookIds[5][0]
        })
      );
    });
